      ...
      <div className=" flex justify-between mb-3">
        ...
        <div className="">
          <Link
            ...
            className="text-white flex justify-center items-center gap-3 bg-[#A16207] hover:bg-[#A16207] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-[#A16207] dark:hover:bg-[#A16207] dark:focus:ring-blue-800"
          >
            Create Sale
            <LuMonitor />
          </Link>
