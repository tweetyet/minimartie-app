  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full text-white flex disabled:pointer-events-none disabled:opacity-80 justify-center items-center gap-3 bg-[#A16207] hover:bg-[#A16207] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#A16207] dark:hover:bg-[#A16207] dark:focus:ring-blue-800"
      >
        Sign in
