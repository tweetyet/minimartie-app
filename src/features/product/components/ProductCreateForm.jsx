    ...
    <div className="rounded-lg w-full md:w-1/2">
      ...
      cursor-pointer"
        ...
        <button
          ...
          className="text-white bg-[#A16207] disabled:pointer-events-none disabled:opacity-80 inline-flex items-center justify-center gap-3 hover:bg-[#A16207]/90 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5"
        >
